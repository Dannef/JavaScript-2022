...
//     member.innerText = `${simpson.name}, ${simpson.surname}, ${simpson.age}, ${simpson.info}`
...
for (const simpson of simpsons) {
    ...
    let info = document.createElement('txt')
    info.innerText = `${simpson.info}`

    let img = document.createElement('img')
    img.src = `${simpson.photo}`

    creation.append(name);
    creation.append(surname);
    creation.append(age);
    creation.append(info);
    creation.append(img);
    document.body.append(creation)
}